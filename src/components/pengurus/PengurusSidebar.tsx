...
interface PengurusSidebarProps {
  isOpen: boolean;
  onClose: () => void;
}

export default function PengurusSidebar({ isOpen, onClose }: PengurusSidebarProps) {
  const pathname = usePathname();

  const menuItems = [
    { name: "Dashboard", href: "/pengurus/dashboard", icon: LayoutDashboard },
    { name: "Santri Binaan", href: "/pengurus/data-santri", icon: Users },
  ];
